...
<!-- prueba GIT -->
	...
	<div id="header">
			...
			<div class="logo">
				<h1 class="titulo"><a href="#"><span>Gonzalo Pachecho</span></a></h1>
			</div>
		</div>
		...
		<div id="menu">
			<ul>
				...
				<li><a href="#" title="BP">BP</a></li>
				<li><a href="#" title="Castrol">Castrol</a></li>
				<li><a href="#" title="Verkol">Verkol</a></li>
				<li><a href="#" title="Kraftwerk">Kraftwerk</a></li>
				<li><a href="#" title="Limpieza">Limpieza</a></li>
		...
		<!-- slider -->
			...
			<div id="columnas">
				...
				<div class="colder">
					...
					<p>Si necesita más información acerca de nuestros productos póngase en contacto a través de este formulario.</p>
					<img src="img/pantallas.png"/><br />
					
					<form action="" class="demo">
						<fieldset>
							<legend>Para solicitar una demo complete el siguiente formulario</legend>
							<label for="nombre">Nombre
							<input name="nombre" type="text" /></label>
							<label for="nombre">Compañía
							 <input type="text" name="compañia" /></label>
							<label for="nombre">E-mail
							<input type="text" name="email" /></label>
							<label for="nombre" class="botonera">
							<button type="button" name="" value="" class="css3button">Solicitar</button></label>
						</fieldset>
					</form> 
